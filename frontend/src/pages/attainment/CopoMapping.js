...
export default function CopoMapping(props) {
    ...
    const coAdd = (e) => {
        e.preventDefault();
        navigate("/mappingcopo", { state: { academicYear,subject,semType} });
    };
    ...
    return (
        <div className="card">
            <div className="card-header text-center font-weight-bold">CO PO Mapping</div>
            <form onSubmit={coAdd}>
