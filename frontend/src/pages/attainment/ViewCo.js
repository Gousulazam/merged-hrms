...
export default function ViewCo(props) {
    ...
    const coView = (e) => {
        e.preventDefault();
        navigate("/coview", { state: { academicYear,subject,semType} });
    };
    ...
    return (
        <div className="card">
            <div className="card-header text-center font-weight-bold">View CO</div>
            <form onSubmit={coView}>
