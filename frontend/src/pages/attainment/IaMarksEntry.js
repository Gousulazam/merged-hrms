...
export default function IaMarksEntry(props) {
    ...
    const coAdd = (e) => {
        e.preventDefault();
        navigate("/marksentryia", { state: { academicYear,subject,semType,internal } });
    };
    ...
    return (
        <div className="card">
            <div className="card-header text-center font-weight-bold">IA Marks Entry</div>
            <form onSubmit={coAdd}>
