...
const ViewSubjectAss = (props) => {
    ...
    useEffect(() => {
     ...
     const [sem, setSem] = useState("")
      ...
      useEffect(() => {
        ...
        const getsubjects = (e) => {
            e.preventDefault();
            Navigate("/viewsubstdass", {state: {academicYear,department, dv,sem, cid} });
        }
  ...
  return (
    ...
    <div className="card">
        ...
        <form method="post" onSubmit={getsubjects}  className="form-horizontal">
