...
const Getupdatestudentlist = (props) => {
    ...
    const getstudent = (e) => {
        e.preventDefault();
        navigate("/Updatestudentlist", { state: { academicYear, department, sem, dv, cid,did } });
    };
                ...
                <div className="card rounded">
                    <form method="post" onSubmit={getstudent} className="form-horizontal">
                        <div className="card-header text-center">
                            <strong className="text-center">Update Student Information</strong>
                        </div>
...
export default Getupdatestudentlist
