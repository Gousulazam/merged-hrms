...
export default function PayDepartmentWise(props) {
    ...
    const coAdd = (e) => {
        e.preventDefault();
        navigate("/departmentwisepay", { state: { academicYear,did,year } });
    };
    const test = async () => {
    ...
    return (
        <div className="card">
            <div className="card-header text-center font-weight-bold">PAY FEES</div>
            <form onSubmit={coAdd}>
