...
export default function SubjectReportDetails(props) {
    ...
    const getSubjectReport = (e) => {
        e.preventDefault();
        navigate("/reportsubjectdetails", { state: { academicYear, subject, semType, fdate, tdate } });
    };
    ...
    return (
        <div className="card">
            <div className="card-header text-center font-weight-bold">Subject Report Details</div>
