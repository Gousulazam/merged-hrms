...
export default function IaReport(props) {
    ...
    const coAdd = (e) => {
        e.preventDefault();
        navigate("/reportia", { state: { academicYear,subject,semType} });
    };
    ...
    return (
        <div className="card">
            <div className="card-header text-center font-weight-bold">IA Report</div>
            <form onSubmit={coAdd}>
