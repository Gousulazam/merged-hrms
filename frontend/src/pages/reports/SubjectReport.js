...
export default function SubjectReport(props) {
    ...
    const getSubjectReport = (e) => {
        e.preventDefault();
        navigate("/reportSubject", { state: { academicYear, subject, semType, fdate, tdate } });
    };
    ...
    return (
        <div className="card">
            <div className="card-header text-center font-weight-bold">Subject Report</div>
